...
def setEnvPaths(project):
    ...
    os.environ['BSW_PROGRAM_DIR'] = os.path.dirname(os.path.dirname(os.path.dirname(pipelinePath)))
    ...
    os.environ['PYTHONPATH'] = os.environ['BSW_PROGRAM_DIR'] + '/bsw_programation/07_python/site-packages'
